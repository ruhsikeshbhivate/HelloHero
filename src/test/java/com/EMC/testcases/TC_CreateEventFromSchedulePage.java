...
public class TC_CreateEventFromSchedulePage extends BaseClass{

	@Test
	public void createEventFromScheduleList() throws InterruptedException
	{
		...
		schedulePage.selectScheduleSubTypes("Eligibility Evaluation");
