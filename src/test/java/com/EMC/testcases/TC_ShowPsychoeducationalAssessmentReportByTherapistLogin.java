...
public class TC_ShowPsychoeducationalAssessmentReportByTherapistLogin extends BaseClass {

	@Test
	public void showPsychoeducationalAssessmentReportByTherapistLogin() throws InterruptedException
	{
		...
		eventPage.selectParticipant("Jacob Monst");
