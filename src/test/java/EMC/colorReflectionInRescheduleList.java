...
public class colorReflectionInRescheduleList {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		participant.selectByVisibleText("Hardik Client");
		...
		Thread.sleep(5000);
		WebElement eventInfo = driver.findElement(By.xpath("//span[text()='Eligibility Assessment with Hardik Client, Bhivate001 Therapist']"));
		...
		startButton.click();
		Thread.sleep(2000);
		WebElement Reschedule = driver.findElement(By.xpath("//button[text()='Reschedule']"));
		Reschedule.click();
		
		WebElement Reschedul_Date = driver.findElement(By.xpath("//input[@id=\"reschedule_date\"]"));
		Reschedul_Date.click();
		Thread.sleep(2000);
		
		WebElement Rechedule_Reason = driver.findElement(By.xpath("//textarea[@id=\"reschedule_reason\"]"));
		Rechedule_Reason.sendKeys("For Automation Test");

		Thread.sleep(2000);
		WebElement reschedule_start_time = driver.findElement(By.xpath("//input[@id=\"reschedule_start_time\"]"));
		reschedule_start_time.click();
		Thread.sleep(2000);
		WebElement reschedule_start_time1 = driver.findElement(By.xpath("(//span[@class=\"glyphicon glyphicon-chevron-up\"])[1]"));
		reschedule_start_time1.click();
		Thread.sleep(1000);
		
		
		WebElement AddToRescheduleList = driver.findElement(By.xpath("//button[text()='Add to Reschedule List']"));
		AddToRescheduleList.click();
		Thread.sleep(1000);

		WebElement YesPopup =driver.findElement(By.xpath("//button[@class=\"swal2-confirm swal2-styled\"]"));
		YesPopup.click();
		Thread.sleep(6000);
