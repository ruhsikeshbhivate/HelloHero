...
public class colorReflectionDocumentationEvents {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		scheduletype.selectByVisibleText("Documentation");
		...
		schedulesubtype.selectByVisibleText("Quarterly Progress Report");
		...
		Thread.sleep(5000);
		WebElement eventInfo = driver.findElement(By.xpath("//span[text()='Quarterly Progress Report with Jimmy Carter, Bhivate001 Therapist']"));
		...
		Thread.sleep(2000);
		executor2.executeScript("window.scrollBy(0,-280)", "");
		Thread.sleep(2000);
