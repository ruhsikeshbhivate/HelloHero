...
public class ColorReflectionGroupSession {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		scheduletype.selectByVisibleText("Session");
		...
		schedulesubtype.selectByVisibleText("Group");
		...
		participant.selectByVisibleText("David Client");
		AddParticipantButton.click();
		Thread.sleep(2000);
		...
		executor1.executeScript("arguments[0].scrollIntoView();",Owner);
		Thread.sleep(2000);
